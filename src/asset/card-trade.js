...
function CardTrade({ itemId, itemName, itemImageUrls, quantity, expiredDate, pickupStartTime, pickupEndTime }) {
    ...
    return(
        <button class="card-row" onClick={()=>navigate(`/trade?id=${itemId}&name=${itemName}`)}>
